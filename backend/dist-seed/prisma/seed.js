...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var comercio, passwordHash, admin, token;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log('🌱 Iniciando seeding...');
                    // Limpiar BD
                    return [4 /*yield*/, prisma.transaccion.deleteMany()];
                case 1:
                    // Limpiar BD
                    _a.sent();
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, prisma.comercio.deleteMany()];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, prisma.comercio.create({
                            data: {
                ...
                case 6:
                    ...
                    token = (0, auth_1.generateToken)({ id_usuario: admin.id_usuario, id_comercio: admin.id_comercio, rol: admin.rol });
                    console.log('\n======================================================');
