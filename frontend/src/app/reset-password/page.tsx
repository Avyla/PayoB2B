  ...
  if (status === 'success') {
    return (
      <div className="text-center">
        ...
        <h3 className="text-lg font-medium text-slate-900 mb-2">Contraseña actualizada</h3>
        <p className="text-sm text-slate-500 mb-6">
          Tu contraseña ha sido restablecida exitosamente. Ya puedes iniciar sesión con tus nuevas credenciales.
        </p>
        <Link
          href="/login"
          className="w-full flex justify-center py-3 px-4 border border-transparent rounded-xl shadow-sm text-sm font-semibold text-white bg-slate-900 hover:bg-slate-800 transition-all"
        >
          Iniciar sesión
        </Link>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center lg:text-left">
            ...
            <h2 className="text-3xl font-bold text-slate-900">Crear nueva contraseña</h2>
            <p className="mt-2 text-sm text-slate-500">Ingresa tu nueva contraseña para tu cuenta de Payo.</p>
          </div>

          <div className="bg-white py-8 px-6 sm:px-10 shadow-xl shadow-slate-200/50 rounded-2xl border border-slate-100">
            <Suspense fallback={<div className="animate-pulse flex space-x-4"><div className="flex-1 space-y-6 py-1"><div className="h-10 bg-slate-200 rounded"></div><div className="h-10 bg-slate-200 rounded"></div><div className="h-10 bg-slate-200 rounded"></div></div></div>}>
              <ResetPasswordForm />
            </Suspense>
          </div>
