      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="mt-2 text-sm text-slate-500">Ingresa tu correo electrónico y te enviaremos instrucciones para restablecer tu contraseña.</p>
          </div>
          ...
          <div className="bg-white py-8 px-6 sm:px-10 shadow-xl shadow-slate-200/50 rounded-2xl border border-slate-100">
            {status === 'success' ? (
              <div className="text-center">
                ...
                <h3 className="text-lg font-medium text-slate-900 mb-2">Revisa tu bandeja de entrada</h3>
                <p className="text-sm text-slate-500 mb-6">
                  Si tu correo electrónico está registrado, recibirás instrucciones para restablecer tu contraseña en breve. Revisa tu carpeta de spam si no lo encuentras.
                </p>
                <Link
                  href="/login"
